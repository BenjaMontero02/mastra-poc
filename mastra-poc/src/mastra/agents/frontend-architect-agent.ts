...
- Si el prompt es ambiguo, usá la skill feature-discovery al inicio para entender el pedido, aclarar ambigüedades relevantes y definir qué tipo de resolución necesita la tarea.
